...
public class ShakeShackAllMenu {
    ...
    public List<Product> burger = new ArrayList<>(Arrays.asList(SHACKBURGER, SMOKESHACK, SHROOM_BURGER, HAMBURGER));
    public List<Product> custard = new ArrayList<>(Arrays.asList(ANTHRACITE_COFFEE_SHAKE, CLASSIC_HAND_SPUN_SHAKE, FLOATS, CUP_CONES));
